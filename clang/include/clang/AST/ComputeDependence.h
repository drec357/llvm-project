...
class ParenExpr;
class UnaryOperator;
class ReflexprIdExpr;
class MetaobjectIdExpr;
class UnaryMetaobjectOpExpr;
class NaryMetaobjectOpExpr;
...
ExprDependence computeDependence(ReflexprIdExpr *E);
ExprDependence computeDependence(MetaobjectIdExpr *E);
ExprDependence computeDependence(UnaryMetaobjectOpExpr *E);
ExprDependence computeDependence(NaryMetaobjectOpExpr *E);
...
ExprDependence computeDependence(CXXSelectExpr *E);
